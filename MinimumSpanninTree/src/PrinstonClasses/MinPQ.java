 ...
 *  Compilation:  javac PrinstonClasses.MinPQ.java
 *  Execution:    java PrinstonClasses.MinPQ < input.txt
 *
 *  Generic min priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order.
 *
 *  % java PrinstonClasses.MinPQ < tinyPQ.txt
 *  E A E (6 left on pq)
 *
...
/**
 *  The <tt>PrinstonClasses.MinPQ</tt> class represents a priority queue of generic keys.
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>PrinstonClasses.MinPQ</tt> data type.
     */
