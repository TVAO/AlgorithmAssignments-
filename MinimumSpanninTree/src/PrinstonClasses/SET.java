 ...
 *  Compilation:  javac PrinstonClasses.SET.java
 *  Execution:    java PrinstonClasses.SET
 *
 *  Set implementation using Java's TreeSet library.
 *  Does not allow duplicates.
 *
 *  % java PrinstonClasses.SET
 *  128.112.136.11
 *  208.216.181.15
 *  null
 *
...
/**
 *  The <tt>PrinstonClasses.SET</tt> class represents an ordered set of comparable keys.
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>PrinstonClasses.SET</tt> data type.
     */
