 ...
 *  (or set of source nodes) to every other vertex in the digraph.
 *  <p>
 *  This implementation uses breadth-first search.
 *  The constructor takes time proportional to <em>V</em> + <em>E</em>,
 *  where <em>V</em> is the number of nodes and <em>E</em> is the number of edges.
...
public class BreadthFirstDirectedPaths {
    ...
    /**
     * Computes the shortest path from any one of the source nodes in <tt>sources</tt>
     ...
     * @param v the vertex
     * @return the sequence of nodes on a shortest path, as an Iterable
     */
